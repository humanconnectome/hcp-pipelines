...
export HCPPIPEDIR="/opt/HCP/HCPpipelines" # Adding this because seems to be missing Mo 09/08/2020
...
cd ${SubjectsFolder}
cp $HOME/processing/ls_struc_preproc/xnat_pbs_jobs_control_CCF_HCD/SpecFiles_v3/* "${StudyFolder}/subjects/specs"
...
${QUNEXCOMMAND} hcp1 \
    ...
    --overwrite="${Overwrite}" \
    --parsessions="${cores}" \
	--hcp_Pipeline="/opt/HCP/HCPpipelines/" \
	--nprocess="0"
