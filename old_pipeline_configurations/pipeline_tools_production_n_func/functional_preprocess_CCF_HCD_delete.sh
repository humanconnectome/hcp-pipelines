...
SubjectFile=${HOME}/pipeline_tools_production_n_func/xnat_pbs_jobs_control_CCF_HCD/failing.subjects

source $HOME/processing/pipeline_tools_production_n_func/xnat_pbs_jobs_control_CCF_HCD/xnat_pbs_setup intradb
