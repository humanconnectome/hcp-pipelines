...
SubjectFile=${HOME}/icafix_Q2_2020_runs/xnat_pbs_jobs_control_CCF_HCD/failing.subjects

source ${HOME}/icafix_Q2_2020_runs/xnat_pbs_jobs_control_CCF_HCD/xnat_pbs_setup intradb
