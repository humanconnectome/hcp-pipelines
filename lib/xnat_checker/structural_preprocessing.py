...
import sys
import argparse
from ccf.one_subject_completion_xnat_checker import StructuralCompletionChecker
...
if __name__ == "__main__":
    ...
    completion_checker = StructuralCompletionChecker(args.project, args.subject, args.classifier)
